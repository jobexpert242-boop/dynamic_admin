...
const setColor = (e) => editor.value?.chain().focus().setColor(e.target.value).run();
...
<template>
  <div :class="['editor-wrapper', isFullscreen ? 'fullscreen' : '']">
    ...
    <div class="toolbar">
      <!-- Font styles -->
      <button type="button" :class="isActive('bold')" @click="cmd('toggleBold')">B</button>
      <button type="button" :class="isActive('italic')" @click="cmd('toggleItalic')">I</button>
      <button type="button" :class="isActive('underline')" @click="cmd('toggleUnderline')">U</button>
      ...
      <!-- Lists -->
      <button type="button" @click="cmd('toggleBulletList')">• List</button>
      <button type="button" @click="cmd('toggleOrderedList')">1. List</button>
      ...
      <!-- Fullscreen -->
      <button type="button" :class="{ 'active-btn': isFullscreen }" @click="toggleFullscreen">
        Fullscreen
      </button>
    </div>
